	...
	<body id="top">
			...
			-->
				<section id="banner" data-video="images/banner">
                    ...
                    <video autoplay="autoplay" loop=""><source src="assets/images/banner.mp4" type="video/mp4"><source src="assets/images/banner.webm" type="video/webm"></video>
				</section>
				...
				<div id="main">
					...
					<!-- Boxes -->
						...
						<div class="thumbnails">
                            ...
                            ?>
							<div class="box">
								<a href="<?= $url ?>" class="image fit" title="ver video"><img src="assets/images/<?= strtolower($marca) ?>.png" alt="logo <?= $marca ?>" /></a>
								<div class="inner">
